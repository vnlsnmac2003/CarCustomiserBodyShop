 ...
 * @author Personal
 */
public class ReceptionistCreateJobScreen extends LayoutFunctions{
        
    JButton backButton = new JButton("Back");
    JButton logoutButton = new JButton("Logout");
    JLabel screenLabel =  new JLabel("Create a New Job");
    ...
    public ReceptionistCreateJobScreen() {
        panel.setLayout(layout);
        statusValueLabel = new JLabel("New");
        dateValueLabel = new JLabel("Date value goes here");
        statusValueLabel.setHorizontalAlignment(SwingConstants.CENTER);
        dateValueLabel.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        gridBagConst.insets = new Insets(0,270,30,270);
    ...
    /*
     public static void main(String[] args) {
        ReceptionistCreateJobScreen screen = new ReceptionistCreateJobScreen();
        screen.setTitle("Custom Car Autos LTD: Create Job");
